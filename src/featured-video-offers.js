...
(function () {
  ...
  var scriptEl =
    ...
    document.querySelector("script[data-ca-video-offers]");
  ...
  function readConfig() {
    ...
    if (scriptEl) {
      sheetUrl =
        (scriptEl.getAttribute("data-sheet-url") || "").trim() || sheetUrl;
      containerId =
        (scriptEl.getAttribute("data-container") || "").trim() || containerId;
  ...
  function buildVideoCard(video) {
    var containerClass = video.isShort
      ...
      : "ca-video-container";
    var cardClass = video.isShort
      ? "ca-video-card ca-video-card--short"
      : "ca-video-card";
    var badgeClass = video.isShort
      ? "ca-video-badge ca-video-badge--short"
      : "ca-video-badge";
  ...
  function init() {
    ...
    if (!container) {
      console.warn(
        "[video-offers] Container #" + config.containerId + " not found.",
      );
      return;
    }
